...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-rice-748b
```

A live public deployment of this template is available at [https://lucky-rice-748b.templates.workers.dev](https://lucky-rice-748b.templates.workers.dev)
